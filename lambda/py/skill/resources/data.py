...
REPEAT_RECIPE = _("Would you like another recipe?")

REPEAT_RANDOM = _("Would you like another random recipe?")
...
ITEMS = {
    ...
    "Demon Scythe": "has a drop chance by defeating demons in the underworld",
    "Night's Edge": "is made by combining the muramasa, blade of grass, fiery greatsword and the lights bane or a blood butcherer",
    "Dark Lance": "can be found in Shadow Chests in the Underworld",
    "Coral": " can be found in the Ocean biomes at the ends of the world",
    "Cactus": "can be found in the Desert biomes",
    "Trident": "found in Water Chests, and OceanDesktop version and Seaside Crates",
    "Silver Bullet": "made with 70 musket balls and a silver bar or can be purchased from the Arms Dealer during hardmode",
    "Throwing Knife": "can be purchased from the Merchant during a Blood Moon and may also be found in Chests",
    "Spear": "can be found in Wooden Chests",
    "Blowpipe": "can be found randomly in Wooden Chests",
    "Glowstick": "can dropped by all Jellyfish, and can be found commonly in Pots and Chests. The can be bought as well from the merchant",
    "Seed": "can be gathered by cutting weeds growing on grass, but only when a character has a blowgun or blowpipe in their inventory.",
    "Wooden Boomerang": "can be found in Wooden Chests",
    "Aglet": "can be found in surface chests, and from Wooden Crates",
    "Sticky Glowstick": "sticky glowsticks are made with gel and a glowstick",
    "Poisoned Knife": "made by combining throwing knife with vicious or vile powder",
    ...
    "Daybloom Seeds": "can be obtained from harvesting Dayblooms",
    "Moonglow Seeds": "can be obtained from harvesting Moonglow",
    "Blinkroot Seeds": "can be obtained from harvesting Blinkroot",
    "Deathweed Seeds": "can be obtained from harvesting Deathweed",
    "Waterleaf Seeds": "can be obtained from harvesting waterleaf",
    "Fireblossom Seeds": "can be obtained from harvesting Fireblossom",
    "Daybloom": "a small yellow flower with a straight stem that grows naturally on Grass",
    "Moonglow": "grows naturally on Jungle grass",
    "Blinkroot": "grows naturally on Dirt or Mud blocks",
    "Deathweed": "can be found growing naturally on Corrupt Grass and Ebonstone",
    "Waterleaf": "grows on Sand and Pearlsand blocks in any type of Desert biome",
    "Fireblossom": "grows on Ash Blocks in The Underworld",
    "Shark Fin": "Dropped from defeating sharks at the ocean",
    "Feather": "dropped from defeating Harpys in the sky biome",
    "Tombstone": "drops when a player dies",
    "Mime Mask": "is purchased from the Clothier during a Blood Moon",
    "Antlion Mandible": "dropped from defeating an antlion",
    "Illegal Gun Parts": "are sold by the Arms Dealer at night",
    "The Doctor's Shirt": "is purchased from the Clothier",
    "The Doctor's Pants": "is purchased from the Clothier",
    "Golden Key": "dropped from defeating a dungeon slime, or found in a dungeon chest",
    "Shadow Chest": "found in the underworld",
    "Shadow Key": "can be found in Special Chests within the Dungeon",
    # "Obsidian Brick Wall": "",
    "Jungle Spores": "Found in the jungle biome",
    # "Loom": "",
    # "Piano": "",
    # "Dresser": "",
    # "Bench": "",
    ...
    # "Paintbrush": "",
    # "Paint Roller": "",
    "Red Paint": "is purchased from the Painter for 25 copper per bucket",
    "Orange Paint": "is purchased from the Painter for 25 copper per bucket",
    "Yellow Paint": "is purchased from the Painter for 25 copper per bucket",
    "Lime Paint": "is purchased from the Painter for 25 copper per bucket",
    "Green Paint": "is purchased from the Painter for 25 copper per bucket",
    "Teal Paint": "is purchased from the Painter for 25 copper per bucket",
    "Cyan Paint": "is purchased from the Painter for 25 copper per bucket",
    "Sky Blue Paint": "is purchased from the Painter for 25 copper per bucket",
    "Blue Paint": "is purchased from the Painter for 25 copper per bucket",
    "Purple Paint": "is purchased from the Painter for 25 copper per bucket",
    "Violet Paint": "is purchased from the Painter for 25 copper per bucket",
    "Pink Paint": "is purchased from the Painter for 25 copper per bucket",
    "Deep Red Paint": "is purchased from the Painter for 25 copper per bucket",
    "Deep Orange Paint": "is purchased from the Painter for 25 copper per bucket",
    "Deep Yellow Paint": "is purchased from the Painter for 25 copper per bucket",
    "Deep Lime Paint": "is purchased from the Painter for 25 copper per bucket",
    "Deep Green Paint": "is purchased from the Painter for 25 copper per bucket",
    "Deep Teal Paint": "is purchased from the Painter for 25 copper per bucket",
    "Deep Cyan Paint": "is purchased from the Painter for 25 copper per bucket",
    "Deep Sky Blue Paint": "is purchased from the Painter for 25 copper per bucket",
    "Deep Blue Paint": "is purchased from the Painter for 25 copper per bucket",
    "Deep Purple Paint": "is purchased from the Painter for 25 copper per bucket",
    "Deep Violet Paint": "is purchased from the Painter for 25 copper per bucket",
    "Deep Pink Paint": "is purchased from the Painter for 25 copper per bucket",
    "Black Paint": "is purchased from the Painter for 25 copper per bucket",
    "White Paint": "is purchased from the Painter for 25 copper per bucket",
    "Gray Paint": "is purchased from the Painter for 25 copper per bucket",
    # "Paint Scraper": "",
    # "Lihzahrd Brick": "",
    # "Lihzahrd Brick Wall": "",
    # "Slush Block": "",
    ...
    # "Fireworks Box": "",
    # "Living Fire Block": "",
    "0' Statue": "crafted at the Heavy Work Bench with 50 Stone Block each",
    "1' Statue": "crafted at the Heavy Work Bench with 50 Stone Block each",
    "2' Statue": "crafted at the Heavy Work Bench with 50 Stone Block each",
    "3' Statue": "crafted at the Heavy Work Bench with 50 Stone Block each",
    "4' Statue": "crafted at the Heavy Work Bench with 50 Stone Block each",
    "5' Statue": "crafted at the Heavy Work Bench with 50 Stone Block each",
    "6' Statue": "crafted at the Heavy Work Bench with 50 Stone Block each",
    "7' Statue": "crafted at the Heavy Work Bench with 50 Stone Block each",
    "8' Statue": "crafted at the Heavy Work Bench with 50 Stone Block each",
    "9' Statue": "crafted at the Heavy Work Bench with 50 Stone Block each",
    "A' Statue": "crafted at the Heavy Work Bench with 50 Stone Block each",
    "B' Statue": "crafted at the Heavy Work Bench with 50 Stone Block each",
    "C' Statue": "crafted at the Heavy Work Bench with 50 Stone Block each",
    "D' Statue": "crafted at the Heavy Work Bench with 50 Stone Block each",
    "E' Statue": "crafted at the Heavy Work Bench with 50 Stone Block each",
    "F' Statue": "crafted at the Heavy Work Bench with 50 Stone Block each",
    "G' Statue": "crafted at the Heavy Work Bench with 50 Stone Block each",
    "H' Statue": "crafted at the Heavy Work Bench with 50 Stone Block each",
    "I' Statue": "crafted at the Heavy Work Bench with 50 Stone Block each",
    "J' Statue": "crafted at the Heavy Work Bench with 50 Stone Block each",
    "K' Statue": "crafted at the Heavy Work Bench with 50 Stone Block each",
    "L' Statue": "crafted at the Heavy Work Bench with 50 Stone Block each",
    "M' Statue": "crafted at the Heavy Work Bench with 50 Stone Block each",
    "N' Statue": "crafted at the Heavy Work Bench with 50 Stone Block each",
    "O' Statue": "crafted at the Heavy Work Bench with 50 Stone Block each",
    "P' Statue": "crafted at the Heavy Work Bench with 50 Stone Block each",
    "Q' Statue": "crafted at the Heavy Work Bench with 50 Stone Block each",
    "R' Statue": "crafted at the Heavy Work Bench with 50 Stone Block each",
    "S' Statue": "crafted at the Heavy Work Bench with 50 Stone Block each",
    "T' Statue": "crafted at the Heavy Work Bench with 50 Stone Block each",
    "U' Statue": "crafted at the Heavy Work Bench with 50 Stone Block each",
    "V' Statue": "crafted at the Heavy Work Bench with 50 Stone Block each",
    "W' Statue": "crafted at the Heavy Work Bench with 50 Stone Block each",
    "X' Statue": "crafted at the Heavy Work Bench with 50 Stone Block each",
    "Y' Statue": "crafted at the Heavy Work Bench with 50 Stone Block each",
    "Z' Statue": "crafted at the Heavy Work Bench with 50 Stone Block each",
    # "Firework Fountain": "",
    # "Booster Track": "",
    # "Grasshopper": "",
    # "Grasshopper Cage": "",
